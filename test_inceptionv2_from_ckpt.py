...
# Initialize model
inceptionv2 = InceptionV2(num_classes=FLAGS.num_classes, train_layers=train_layers)
...
with tf.Session() as sess:
    ...
    model_file = tf.train.latest_checkpoint("./runs/inceptionv2/1544497939/ckpt/")
